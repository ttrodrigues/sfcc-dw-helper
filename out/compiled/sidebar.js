var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "openSection svelte-13lyhed");
    			...
    			attr_dev(path1, "class", "closeSection svelte-13lyhed");
    			...
    			attr_dev(div1, "class", "collapsible svelte-13lyhed");
    ...
    // (239:4) <CollapsibleSection headerText={'Environment'} expanded={true}>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 241, 16, 6598);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "hostname");
    			attr_dev(input0, "class", "svelte-1kfb42i");
    			add_location(input0, file, 242, 16, 6635);
    			attr_dev(button0, "id", "btnSvgHostname");
    			attr_dev(button0, "class", "svelte-1kfb42i");
    			add_location(button0, file, 248, 16, 6902);
    			add_location(div1, file, 240, 12, 6575);
    			add_location(div2, file, 255, 16, 7110);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "codeVersion");
    			attr_dev(input1, "class", "svelte-1kfb42i");
    			add_location(input1, file, 256, 16, 7151);
    			attr_dev(button1, "id", "btnSvgCodeversion");
    			attr_dev(button1, "class", "svelte-1kfb42i");
    			add_location(button1, file, 262, 16, 7428);
    			add_location(div3, file, 254, 12, 7087);
    			add_location(div4, file, 268, 12, 7619);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "userName");
    			attr_dev(input2, "class", "svelte-1kfb42i");
    			add_location(input2, file, 269, 12, 7653);
    			add_location(div5, file, 274, 16, 7801);
    			attr_dev(input3, "type", input3_type_value = /*isPasswordVisible*/ ctx[12] ? "text" : "password");
    			attr_dev(input3, "id", "password");
    			attr_dev(input3, "class", "svelte-1kfb42i");
    			add_location(input3, file, 275, 16, 7838);
    			attr_dev(button2, "id", "btnSvgPassword");
    			attr_dev(button2, "class", "svelte-1kfb42i");
    			add_location(button2, file, 280, 16, 8077);
    			add_location(div6, file, 273, 12, 7778);
    			attr_dev(div7, "id", "environmentBtns");
    			attr_dev(div7, "class", "svelte-1kfb42i");
    			add_location(div7, file, 239, 8, 6535);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(239:4) <CollapsibleSection headerText={'Environment'} expanded={true}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(288:4) {#if isProphetInstalled}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-1kfb42i");
    			add_location(button, file, 292, 24, 8505);
    			add_location(div, file, 291, 20, 8474);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(291:16) {#if isToShowDevBuildBtn}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-1kfb42i");
    			add_location(button, file, 300, 24, 8857);
    			add_location(div, file, 299, 20, 8826);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(299:16) {#if isToShowPrdBuildBtn}",
    		ctx
    	});
    ...
    // (289:8) <CollapsibleSection headerText={'Compiler'} expanded={true}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1kfb42i");
    			add_location(div, file, 289, 12, 8387);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(289:8) <CollapsibleSection headerText={'Compiler'} expanded={true}>",
    		ctx
    	});
    ...
    // (309:8) <CollapsibleSection headerText={'Commands'} expanded={true}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "btn-prophet monaco-button monaco-text-button svelte-1kfb42i");
    			add_location(button0, file, 311, 20, 9326);
    			add_location(div0, file, 310, 16, 9299);
    			attr_dev(button1, "class", "btn-prophet monaco-button monaco-text-button svelte-1kfb42i");
    			add_location(button1, file, 317, 20, 9605);
    			add_location(div1, file, 316, 16, 9578);
    			attr_dev(button2, "class", "btn-prophet monaco-button monaco-text-button svelte-1kfb42i");
    			add_location(button2, file, 323, 20, 9852);
    			add_location(div2, file, 322, 16, 9825);
    			attr_dev(div3, "id", "prophetBtn");
    			attr_dev(div3, "class", "svelte-1kfb42i");
    			add_location(div3, file, 309, 12, 9260);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(309:8) <CollapsibleSection headerText={'Commands'} expanded={true}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1kfb42i");
    			add_location(div, file, 236, 0, 6439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
