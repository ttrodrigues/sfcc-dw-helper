var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(215:8) {#if isProphetInstalled}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 218, 24, 6170);
    			add_location(div, file, 217, 20, 6139);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(217:16) {#if isToShowDevBuildBtn}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-dyz7e7");
    			add_location(button, file, 226, 24, 6522);
    			add_location(div, file, 225, 20, 6491);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(225:16) {#if isToShowPrdBuildBtn}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 187, 8, 5189);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "hostname");
    			attr_dev(input0, "class", "svelte-dyz7e7");
    			add_location(input0, file, 188, 8, 5218);
    			add_location(div1, file, 192, 8, 5327);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "codeVersion");
    			attr_dev(input1, "class", "svelte-dyz7e7");
    			add_location(input1, file, 193, 8, 5360);
    			add_location(div2, file, 197, 8, 5472);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "userName");
    			attr_dev(input2, "class", "svelte-dyz7e7");
    			add_location(input2, file, 198, 8, 5502);
    			add_location(div3, file, 203, 12, 5630);
    			...
    			add_location(input3, file, 204, 12, 5663);
    			attr_dev(button, "id", "btnSvg");
    			attr_dev(button, "class", "svelte-dyz7e7");
    			add_location(button, file, 209, 12, 5882);
    			add_location(div4, file, 202, 8, 5611);
    			attr_dev(div5, "id", "main");
    			attr_dev(div5, "class", "svelte-dyz7e7");
    			add_location(div5, file, 185, 0, 5162);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
