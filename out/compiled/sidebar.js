var app = (function () {
    ...
    // (240:4) <CollapsibleSection headerText={'Environment'} expanded={true}>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 242, 16, 6623);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "hostname");
    			attr_dev(input0, "class", "svelte-1fp1nly");
    			add_location(input0, file, 243, 16, 6660);
    			attr_dev(button0, "id", "btnSvgHostname");
    			attr_dev(button0, "class", "svelte-1fp1nly");
    			add_location(button0, file, 249, 16, 6927);
    			add_location(div1, file, 241, 12, 6600);
    			add_location(div2, file, 256, 16, 7135);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "codeVersion");
    			attr_dev(input1, "class", "svelte-1fp1nly");
    			add_location(input1, file, 257, 16, 7176);
    			attr_dev(button1, "id", "btnSvgCodeversion");
    			attr_dev(button1, "class", "svelte-1fp1nly");
    			add_location(button1, file, 263, 16, 7453);
    			add_location(div3, file, 255, 12, 7112);
    			add_location(div4, file, 269, 12, 7644);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "userName");
    			attr_dev(input2, "class", "svelte-1fp1nly");
    			add_location(input2, file, 270, 12, 7678);
    			add_location(div5, file, 275, 16, 7826);
    			attr_dev(input3, "type", input3_type_value = /*isPasswordVisible*/ ctx[12] ? "text" : "password");
    			attr_dev(input3, "id", "password");
    			attr_dev(input3, "class", "svelte-1fp1nly");
    			add_location(input3, file, 276, 16, 7863);
    			attr_dev(button2, "id", "btnSvgPassword");
    			attr_dev(button2, "class", "svelte-1fp1nly");
    			add_location(button2, file, 281, 16, 8102);
    			add_location(div6, file, 274, 12, 7803);
    			attr_dev(div7, "id", "environmentBtns");
    			attr_dev(div7, "class", "svelte-1fp1nly");
    			add_location(div7, file, 240, 8, 6560);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(240:4) <CollapsibleSection headerText={'Environment'} expanded={true}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(289:4) {#if isProphetInstalled}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-1fp1nly");
    			add_location(button, file, 293, 24, 8530);
    			add_location(div, file, 292, 20, 8499);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(292:16) {#if isToShowDevBuildBtn}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-1fp1nly");
    			add_location(button, file, 301, 24, 8882);
    			add_location(div, file, 300, 20, 8851);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(300:16) {#if isToShowPrdBuildBtn}",
    		ctx
    	});
    ...
    // (290:8) <CollapsibleSection headerText={'Compiler'} expanded={true}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1fp1nly");
    			add_location(div, file, 290, 12, 8412);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(290:8) <CollapsibleSection headerText={'Compiler'} expanded={true}>",
    		ctx
    	});
    ...
    // (310:8) <CollapsibleSection headerText={'Commands'} expanded={true}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "btn-prophet monaco-button monaco-text-button svelte-1fp1nly");
    			add_location(button0, file, 312, 20, 9351);
    			add_location(div0, file, 311, 16, 9324);
    			attr_dev(button1, "class", "btn-prophet monaco-button monaco-text-button svelte-1fp1nly");
    			add_location(button1, file, 318, 20, 9630);
    			add_location(div1, file, 317, 16, 9603);
    			attr_dev(button2, "class", "btn-prophet monaco-button monaco-text-button svelte-1fp1nly");
    			add_location(button2, file, 324, 20, 9877);
    			add_location(div2, file, 323, 16, 9850);
    			attr_dev(div3, "id", "prophetBtn");
    			attr_dev(div3, "class", "svelte-1fp1nly");
    			add_location(div3, file, 310, 12, 9285);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(310:8) <CollapsibleSection headerText={'Commands'} expanded={true}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1fp1nly");
    			add_location(div, file, 237, 0, 6464);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
