var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "class", "openSection svelte-1svr2fd");
    			...
    			attr_dev(path1, "class", "closeSection svelte-1svr2fd");
    			...
    			attr_dev(div1, "class", "collapsible svelte-1svr2fd");
    ...
    // (245:4) <CollapsibleSection headerText={'Environment'} expanded={true}>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "textInput svelte-nyl3g5");
    			add_location(div0, file, 247, 16, 6708);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "hostname");
    			attr_dev(input0, "class", "svelte-nyl3g5");
    			add_location(input0, file, 248, 16, 6763);
    			attr_dev(button0, "id", "btnSvgHostname");
    			attr_dev(button0, "class", "svelte-nyl3g5");
    			add_location(button0, file, 254, 16, 7030);
    			add_location(div1, file, 246, 12, 6685);
    			attr_dev(div2, "class", "textInput svelte-nyl3g5");
    			add_location(div2, file, 261, 16, 7238);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "codeVersion");
    			attr_dev(input1, "class", "svelte-nyl3g5");
    			add_location(input1, file, 262, 16, 7297);
    			attr_dev(button1, "id", "btnSvgCodeversion");
    			attr_dev(button1, "class", "svelte-nyl3g5");
    			add_location(button1, file, 268, 16, 7574);
    			add_location(div3, file, 260, 12, 7215);
    			attr_dev(div4, "class", "textInput svelte-nyl3g5");
    			add_location(div4, file, 274, 12, 7765);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "userName");
    			attr_dev(input2, "class", "svelte-nyl3g5");
    			add_location(input2, file, 275, 12, 7817);
    			attr_dev(div5, "class", "textInput svelte-nyl3g5");
    			add_location(div5, file, 280, 16, 7965);
    			attr_dev(input3, "type", input3_type_value = /*isPasswordVisible*/ ctx[12] ? "text" : "password");
    			attr_dev(input3, "id", "password");
    			attr_dev(input3, "class", "svelte-nyl3g5");
    			add_location(input3, file, 281, 16, 8020);
    			attr_dev(button2, "id", "btnSvgPassword");
    			attr_dev(button2, "class", "svelte-nyl3g5");
    			add_location(button2, file, 286, 16, 8259);
    			add_location(div6, file, 279, 12, 7942);
    			attr_dev(div7, "id", "environmentBtns");
    			attr_dev(div7, "class", "svelte-nyl3g5");
    			add_location(div7, file, 245, 8, 6645);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(245:4) <CollapsibleSection headerText={'Environment'} expanded={true}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(294:4) {#if isProphetInstalled}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-nyl3g5");
    			add_location(button, file, 298, 24, 8687);
    			add_location(div, file, 297, 20, 8656);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(297:16) {#if isToShowDevBuildBtn}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-nyl3g5");
    			add_location(button, file, 306, 24, 9039);
    			add_location(div, file, 305, 20, 9008);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(305:16) {#if isToShowPrdBuildBtn}",
    		ctx
    	});
    ...
    // (295:8) <CollapsibleSection headerText={'Compiler'} expanded={true}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-nyl3g5");
    			add_location(div, file, 295, 12, 8569);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(295:8) <CollapsibleSection headerText={'Compiler'} expanded={true}>",
    		ctx
    	});
    ...
    // (315:8) <CollapsibleSection headerText={'Commands'} expanded={true}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "btn-prophet monaco-button monaco-text-button svelte-nyl3g5");
    			add_location(button0, file, 317, 20, 9508);
    			add_location(div0, file, 316, 16, 9481);
    			attr_dev(button1, "class", "btn-prophet monaco-button monaco-text-button svelte-nyl3g5");
    			add_location(button1, file, 323, 20, 9787);
    			add_location(div1, file, 322, 16, 9760);
    			attr_dev(button2, "class", "btn-prophet monaco-button monaco-text-button svelte-nyl3g5");
    			add_location(button2, file, 329, 20, 10034);
    			add_location(div2, file, 328, 16, 10007);
    			attr_dev(div3, "id", "prophetBtn");
    			attr_dev(div3, "class", "svelte-nyl3g5");
    			add_location(div3, file, 315, 12, 9442);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(315:8) <CollapsibleSection headerText={'Commands'} expanded={true}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-nyl3g5");
    			add_location(div, file, 242, 0, 6549);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
