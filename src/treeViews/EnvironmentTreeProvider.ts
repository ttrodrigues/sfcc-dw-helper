  ...
  async getChildren(element?: EnvironmentTreeItem): Promise<EnvironmentTreeItem[]> {
    if (!element) {
      ...
      return [
        ...
        new EnvironmentTreeItem("Open StoreFront", "env:openSF", vscode.TreeItemCollapsibleState.None, "action", "globe"),
        new EnvironmentTreeItem("New Code Version", "env:newCodeVersion", vscode.TreeItemCollapsibleState.None, "action", "add"),
        new EnvironmentTreeItem("Delete Code Version", "env:deleteCodeVersion", vscode.TreeItemCollapsibleState.None, "action", "trash"),
      ];
    }
