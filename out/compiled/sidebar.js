var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "svelte-pit4nf");
    			add_location(div0, file, 213, 12, 5998);
    			attr_dev(button0, "class", "btn-prophet monaco-button monaco-text-button svelte-pit4nf");
    			add_location(button0, file, 232, 20, 6822);
    			add_location(div1, file, 231, 16, 6795);
    			attr_dev(button1, "class", "btn-prophet monaco-button monaco-text-button svelte-pit4nf");
    			add_location(button1, file, 238, 20, 7097);
    			add_location(div2, file, 237, 16, 7070);
    			attr_dev(button2, "class", "btn-prophet monaco-button monaco-text-button svelte-pit4nf");
    			add_location(button2, file, 244, 20, 7340);
    			add_location(div3, file, 243, 16, 7313);
    			attr_dev(div4, "id", "prophetBtn");
    			attr_dev(div4, "class", "svelte-pit4nf");
    			add_location(div4, file, 230, 12, 6756);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(213:8) {#if isProphetInstalled}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-pit4nf");
    			add_location(button, file, 216, 24, 6116);
    			add_location(div, file, 215, 20, 6085);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(215:16) {#if isToShowDevBuildBtn}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn-build monaco-button monaco-text-button svelte-pit4nf");
    			add_location(button, file, 224, 24, 6468);
    			add_location(div, file, 223, 20, 6437);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(223:16) {#if isToShowPrdBuildBtn}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 185, 8, 5135);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "hostname");
    			attr_dev(input0, "class", "svelte-pit4nf");
    			add_location(input0, file, 186, 8, 5164);
    			add_location(div1, file, 190, 8, 5273);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "codeVersion");
    			attr_dev(input1, "class", "svelte-pit4nf");
    			add_location(input1, file, 191, 8, 5306);
    			add_location(div2, file, 195, 8, 5418);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "userName");
    			attr_dev(input2, "class", "svelte-pit4nf");
    			add_location(input2, file, 196, 8, 5448);
    			add_location(div3, file, 201, 12, 5576);
    			attr_dev(input3, "type", input3_type_value = /*isPasswordVisible*/ ctx[8] ? "text" : "password");
    			attr_dev(input3, "id", "password");
    			attr_dev(input3, "class", "svelte-pit4nf");
    			add_location(input3, file, 202, 12, 5609);
    			attr_dev(button, "id", "btnSvg");
    			attr_dev(button, "class", "svelte-pit4nf");
    			add_location(button, file, 207, 12, 5828);
    			add_location(div4, file, 200, 8, 5557);
    			attr_dev(div5, "id", "main");
    			attr_dev(div5, "class", "svelte-pit4nf");
    			add_location(div5, file, 183, 0, 5108);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input1, "change", /*change_handler_1*/ ctx[16], false, false, false),
    					listen_dev(input2, "change", /*change_handler_2*/ ctx[17], false, false, false),
    					listen_dev(input3, "change", /*change_handler_3*/ ctx[18], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*isPasswordVisible*/ 256 && input3_type_value !== (input3_type_value = /*isPasswordVisible*/ ctx[8] ? "text" : "password")) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function buttonClick() {
    		$$invalidate(8, isPasswordVisible = !isPasswordVisible);
