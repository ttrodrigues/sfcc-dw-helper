    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = text(t12_value);
    			add_location(div0, file, 108, 8, 3307);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "hostname");
    			attr_dev(input0, "class", "svelte-grxu1u");
    			add_location(input0, file, 109, 8, 3336);
    			add_location(div1, file, 113, 8, 3445);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "codeVersion");
    			attr_dev(input1, "class", "svelte-grxu1u");
    			add_location(input1, file, 114, 8, 3478);
    			add_location(div2, file, 118, 8, 3590);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "userName");
    			attr_dev(input2, "class", "svelte-grxu1u");
    			add_location(input2, file, 119, 8, 3620);
    			add_location(div3, file, 123, 8, 3729);
    			attr_dev(input3, "type", input3_type_value = /*isPasswordVisible*/ ctx[0] ? "text" : "password");
    			attr_dev(input3, "id", "password");
    			attr_dev(input3, "class", "svelte-grxu1u");
    			add_location(input3, file, 124, 8, 3758);
    			attr_dev(button, "id", "btnSeePassword");
    			attr_dev(button, "class", "monaco-button monaco-text-button svelte-grxu1u");
    			add_location(button, file, 128, 8, 3902);
    			attr_dev(div4, "id", "main");
    			attr_dev(div4, "class", "svelte-grxu1u");
    			add_location(div4, file, 106, 0, 3280);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input2, "change", /*change_handler_2*/ ctx[4], false, false, false),
    					listen_dev(input3, "change", /*change_handler_3*/ ctx[5], false, false, false),
